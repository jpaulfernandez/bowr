...
const analyticsHost = process.env.EXPO_PUBLIC_POSTHOG_HOST || undefined;
...
writeFileSync(join(output, 'config.json'), `${JSON.stringify(buildOutputConfig({ supabaseUrl, mediaOrigin, analyticsHost }), null, 2)}\n`);
